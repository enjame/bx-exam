...
<div class="review-block">
    ...
    <div style="clear: both;" class="review-img-wrap">
        ...
        <? else: ?>
            <img src="<?= SITE_TEMPLATE_PATH ?>/media/img/no_photo.jpg">
        <? endif; ?>
    </div>
</div>
<? if (is_set($arResult["DISPLAY_PROPERTIES"]["DOCUMENTS"])): ?>
    <div class="exam-review-doc">
        ...
        <? foreach ($arResult["DISPLAY_PROPERTIES"]["DOCUMENTS"]["FILE_VALUE"] as $file): ?>
            <div class="exam-review-item-doc"><img class="rew-doc-ico" src="<?= SITE_TEMPLATE_PATH ?>/media/img/icons/pdf_ico_40.png">
